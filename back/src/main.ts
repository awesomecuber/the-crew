...
const BLOCKED_COMMUNICATION = new Communication(
    BLANK_CARD,
    CommunicationToken.Only
);
    ...
    rl.question("Input h for help", (answer) => {
        switch (answer.toLowerCase()) {
            case "d":
                ...
                console.log(
                    "The current trick is: " + game.trick.trickToString()
                );
                for (let i: number = 0; i < 4; i++) {
            ...
            case "c":
                ...
                let cardId: number = -1;
                rl.question(
                    "Which player should play a card? (0, 1, 2, or 3)",
                    (answer) => {
                        switch (answer) {
                            case "0":
                        ...
                        rl.question(
                            "Which card (0-9) from their hand should they play?  " +
                                str,
                            (answer) => {
                                switch (answer) {
                                    case "0":
                                ...
                                if (playId != -1 && cardId != -1) {
                                    game.update_playCard(
                                        playId,
                                        game.players[playId].hand[cardId]
                                    );
                                }
                                beginInputPrompt();
                            }
